<xsl:stylesheet xmlns:database="http://general_server.org/xmlnamespaces/database/2006" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gs="http://general_server.org/xmlnamespaces/general_server/2006" xmlns:exsl="http://exslt.org/common" xmlns:interface="http://general_server.org/xmlnamespaces/interface/2006" xmlns:object="http://general_server.org/xmlnamespaces/object/2006" xmlns:repository="http://general_server.org/xmlnamespaces/repository/2006" xmlns:response="http://general_server.org/xmlnamespaces/response/2006" xmlns:session="http://general_server.org/xmlnamespaces/session/2006" xmlns:conversation="http://general_server.org/xmlnamespaces/conversation/2006" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:html="http://www.w3.org/1999/xhtml" xmlns:service="http://general_server.org/xmlnamespaces/service/2006" xmlns:request="http://general_server.org/xmlnamespaces/request/2006" xmlns:rx="http://general_server.org/xmlnamespaces/rx/2006" xmlns:javascript="http://general_server.org/xmlnamespaces/javascript/2006" xmlns:class="http://general_server.org/xmlnamespaces/class/2006" xmlns:css="http://general_server.org/xmlnamespaces/css/2006" xmlns:xmlsecurity="http://general_server.org/xmlnamespaces/xmlsecurity/2006" xmlns:xmltransaction="http://general_server.org/xmlnamespaces/xmltransaction/2006" xmlns:regexp="http://exslt.org/regular-expressions" xmlns:meta="http://general_server.org/xmlnamespaces/meta/2006" xmlns:debug="http://general_server.org/xmlnamespaces/debug/2006" version="1.0" exclude-result-prefixes="#default repository gs database debug conversation xxx html rx class xmlsecurity xmltransaction xsl object interface xsd service javascript css meta response"><!--recommended xsl:output (firefox requires a HTMLDocument object from @method to work)--><xsl:output method="html" version="4.01" encoding="UTF-8" doctype-public="-//W3C//DTD HTML 4.01//EN" doctype-system="http://www.w3.org/TR/html4/strict.dtd"/><!--[/~Class/interface_translators.dxsl] DXSL--><xsl:template match="*" mode="gs_view_render" xsl:is-literal="1"><!--
      ...
      --><xsl:param name="gs_interface_mode" xsl:is-literal="1"/><xsl:param name="gs_current_external_value_node" xsl:is-literal="1" select="/.."/><xsl:param name="gs_title" xsl:is-literal="1" select="xsd:annotation/xsd:*[@meta:type='title']"/><xsl:param name="gs_submit" xsl:is-literal="1" select="xsd:annotation/xsd:*[@meta:type='submit-caption']"/><xsl:param name="gs_description" xsl:is-literal="1" select="xsd:annotation/xsd:*[@meta:type='description']"/><xsl:param name="gs_event_functions" xsl:is-literal="1" select="''"/><xsl:param name="gs_current_value_node" xsl:is-literal="1" select="xsd:annotation/xsd:*[@meta:type='edit-data']/*"/><xsl:param name="gs_field_model" xsl:is-literal="1" select="ancestor::xsd:schema[1]/xsd:annotation[@meta:type='data-queries']/xsd:app-info[@meta:type='field-model']/xsd:schema"/><xsl:param name="gs_field_types" xsl:is-literal="1" select="ancestor::xsd:schema[1]/xsd:annotation[@meta:type='data-queries']/xsd:app-info[@meta:type='field-types']/xsd:schema"/><xsl:param name="gs_sub_interface" xsl:is-literal="1" select="''"/><!--main and complex default interface--><xsl:variable name="gs_default_interface_fragment" xsl:is-literal="1"><xsl:value-of select="$gs_interface_mode" xsl:is-literal="1"/><xsl:if test="not($gs_interface_mode)" xsl:is-literal="1"><xsl:value-of select="@gs:interface-mode" xsl:is-literal="1"/></xsl:if></xsl:variable><xsl:variable name="gs_default_interface" select="string($gs_default_interface_fragment)" xsl:is-literal="1"/><xsl:variable name="gs_main_interface_fragment" xsl:is-literal="1"><xsl:value-of select="substring-before($gs_default_interface, '-')" xsl:is-literal="1"/><xsl:if test="not(contains($gs_default_interface, '-'))" xsl:is-literal="1"><xsl:value-of select="$gs_default_interface" xsl:is-literal="1"/></xsl:if></xsl:variable><xsl:variable name="gs_main_interface" select="string($gs_main_interface_fragment)" xsl:is-literal="1"/><!--classes analysis and extended attributes--><xsl:variable name="gs_html_identifier_class" xsl:is-literal="1"><xsl:apply-templates select="." mode="gs_html_identifier_class" xsl:is-literal="1"><xsl:with-param name="gs_interface_mode" select="$gs_default_interface" xsl:is-literal="1"/></xsl:apply-templates></xsl:variable><!--begin @gs:interface-mode choose--><xsl:choose xsl:is-literal="1"><xsl:when test="$gs_main_interface='editor'" xsl:is-literal="1"><xsl:apply-templates select="." mode="editor" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/><xsl:with-param name="gs_field_model" select="$gs_field_model" xsl:is-literal="1"/><xsl:with-param name="gs_field_types" select="$gs_field_types" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='html'" xsl:is-literal="1"><xsl:apply-templates select="." mode="html" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='xpathajax'" xsl:is-literal="1"><xsl:apply-templates select="." mode="xpathajax" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/><xsl:with-param name="gs_current_external_value_node" select="$gs_current_external_value_node" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='new'" xsl:is-literal="1"><xsl:apply-templates select="." mode="new" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='set'" xsl:is-literal="1"><xsl:apply-templates select="." mode="set" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='selectoroption'" xsl:is-literal="1"><xsl:apply-templates select="." mode="selectoroption" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='eventhandler'" xsl:is-literal="1"><xsl:apply-templates select="." mode="eventhandler" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='view'" xsl:is-literal="1"><xsl:apply-templates select="." mode="view" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='controller'" xsl:is-literal="1"><xsl:apply-templates select="." mode="controller" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='securityowner'" xsl:is-literal="1"><xsl:apply-templates select="." mode="securityowner" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='controls'" xsl:is-literal="1"><xsl:apply-templates select="." mode="controls" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='link'" xsl:is-literal="1"><xsl:apply-templates select="." mode="link" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='list'" xsl:is-literal="1"><xsl:apply-templates select="." mode="list" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/><xsl:with-param name="gs_sub_interface" select="$gs_sub_interface" xsl:is-literal="1"/><xsl:with-param name="gs_event_functions" select="$gs_event_functions" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='listname'" xsl:is-literal="1"><xsl:apply-templates select="." mode="listname" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='securitypermissions'" xsl:is-literal="1"><xsl:apply-templates select="." mode="securitypermissions" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="$gs_main_interface='environment'" xsl:is-literal="1"><xsl:apply-templates select="." mode="environment" xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_interface_mode" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:when test="not($gs_default_interface) or $gs_default_interface = 'default'" xsl:is-literal="1"><xsl:apply-templates select="." xsl:is-literal="1"><xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class" xsl:is-literal="1"/><xsl:with-param name="gs_interface_mode" select="$gs_default_interface" xsl:is-literal="1"/><xsl:with-param name="gs_current_external_value_node" select="$gs_current_external_value_node" xsl:is-literal="1"/><xsl:with-param name="gs_title" select="$gs_title" xsl:is-literal="1"/><xsl:with-param name="gs_submit" select="$gs_submit" xsl:is-literal="1"/><xsl:with-param name="gs_description" select="$gs_description" xsl:is-literal="1"/><xsl:with-param name="gs_event_functions" select="$gs_event_functions" xsl:is-literal="1"/><xsl:with-param name="gs_current_value_node" select="$gs_current_value_node" xsl:is-literal="1"/></xsl:apply-templates></xsl:when><xsl:otherwise xsl:is-literal="1"><div class="gs-warning" xsl:is-literal="1">[<xsl:value-of select="name()" xsl:is-literal="1"/>] @meta:interface [<xsl:value-of select="$gs_default_interface" xsl:is-literal="1"/>=<xsl:value-of select="$gs_main_interface" xsl:is-literal="1"/>] not caught during @mode=gs_view_render</div></xsl:otherwise></xsl:choose></xsl:template><!--/[/~Class/interface_translators.dxsl]--><!--[/~Class/class_introspection.dxsl] DXSL--><!--class attribute defaults--><xsl:template match="*" mode="gs_html_container" xsl:is-literal="1"/><xsl:template match="*" mode="gs_debug" xsl:is-literal="1"/><!--classes--><xsl:template match="interface:Overlay" mode="gs_classes_string" meta:base-class-count="0" xsl:is-literal="1">Overlay</xsl:template><xsl:template match="*" mode="gs_classes_string" meta:base-class-count="2" xsl:is-literal="1">DatabaseElement</xsl:template><xsl:template match="repository:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">Repository</xsl:template><xsl:template match="class:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">Class</xsl:template><xsl:template match="xmltransaction:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">Transaction</xsl:template><xsl:template match="html:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">HTML</xsl:template><xsl:template match="gs:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">GS</xsl:template><xsl:template match="css:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">CSS</xsl:template><xsl:template match="response:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">ResponseNamespace</xsl:template><xsl:template match="object:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">ObjectClass</xsl:template><xsl:template match="xsd:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">XSD</xsl:template><xsl:template match="interface:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">Interface</xsl:template><xsl:template match="xml:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">XML</xsl:template><xsl:template match="database:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">DatabaseNamespace</xsl:template><xsl:template match="xmltransaction:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">XMLTransaction</xsl:template><xsl:template match="xsl:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">XSL</xsl:template><xsl:template match="meta:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">Meta</xsl:template><xsl:template match="rx:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">RegularX</xsl:template><xsl:template match="javascript:*" mode="gs_classes_string" meta:base-class-count="5" xsl:is-literal="1">JS</xsl:template><xsl:template match="interface:Forum" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Forum</xsl:template><xsl:template match="interface:ForumPost" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">ForumPost</xsl:template><xsl:template match="xsl:include" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">XSLInclude</xsl:template><xsl:template match="interface:HTMLWebpage" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">HTMLWebpage</xsl:template><xsl:template match="javascript:dependency" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">JavaScriptDependency</xsl:template><xsl:template match="css:stylesheet" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">CSSStylesheet</xsl:template><xsl:template match="interface:Debugger" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Debugger</xsl:template><xsl:template match="interface:MultiDocument" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">MultiDocument</xsl:template><xsl:template match="interface:Explorer" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Explorer</xsl:template><xsl:template match="interface:IDE" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">IDE</xsl:template><xsl:template match="interface:Frame" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Frame</xsl:template><xsl:template match="interface:MultiView" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">MultiView</xsl:template><xsl:template match="interface:VerticalFrameset|interface:HorizontalFrameset" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Frameset</xsl:template><xsl:template match="interface:SharedInterfaces" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">SharedInterfaces</xsl:template><xsl:template match="interface:AJAXHTMLLoader" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">AJAXHTMLLoader</xsl:template><xsl:template match="interface:Collection" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Collection</xsl:template><xsl:template match="interface:HTMLContainer" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">HTMLContainer</xsl:template><xsl:template match="xsd:schema" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">XSchema</xsl:template><xsl:template match="xsd:element|xsd:attribute|xsd:any" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">XSDField</xsl:template><xsl:template match="xsl:template" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">XSLTemplate</xsl:template><xsl:template match="javascript:code" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">JavaScript</xsl:template><xsl:template match="interface:QualifiedName" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">QualifiedName</xsl:template><xsl:template match="html:img" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">HTMLImage</xsl:template><xsl:template match="interface:Menu" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Menu</xsl:template><xsl:template match="xsl:stylesheet" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">XSLStylesheet</xsl:template><xsl:template match="css:dependency" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">CSSDependency</xsl:template><xsl:template match="xsl:variable|xsl:param" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">XSLVariable</xsl:template><xsl:template match="object:Message" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Message</xsl:template><xsl:template match="object:Response" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Response</xsl:template><xsl:template match="object:LinkedServer" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">LinkedServer</xsl:template><xsl:template match="object:Request" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Request</xsl:template><xsl:template match="repository:resources" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Resources</xsl:template><xsl:template match="object:Website" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Website</xsl:template><xsl:template match="object:User" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">User</xsl:template><xsl:template match="object:Database" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Database</xsl:template><xsl:template match="object:Session" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Session</xsl:template><xsl:template match="object:Service" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Service</xsl:template><xsl:template match="object:Group" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Group</xsl:template><xsl:template match="object:Server" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">Server</xsl:template><xsl:template match="object:MessageInterpretation" mode="gs_classes_string" meta:base-class-count="6" xsl:is-literal="1">MessageInterpretation</xsl:template><xsl:template match="object:Person" mode="gs_classes_string" meta:base-class-count="7" xsl:is-literal="1">Person</xsl:template><xsl:template match="interface:AdvancedForum" mode="gs_classes_string" meta:base-class-count="7" xsl:is-literal="1">AdvancedForum</xsl:template><xsl:template match="xsd:attribute[@meta:editor-class = 'class:CodeMirrorEditor']" mode="gs_classes_string" meta:base-class-count="7" xsl:is-literal="1">CodeMirrorEditor</xsl:template><xsl:template match="xsl:attribute[@meta:editor-class = 'class:Selector']" mode="gs_classes_string" meta:base-class-count="7" xsl:is-literal="1">Selector</xsl:template><xsl:template match="interface:VerticalMenu" mode="gs_classes_string" meta:base-class-count="7" xsl:is-literal="1">VerticalMenu</xsl:template><xsl:template match="interface:HorizontalMenu" mode="gs_classes_string" meta:base-class-count="7" xsl:is-literal="1">HorizontalMenu</xsl:template><xsl:template match="object:HTTP" mode="gs_classes_string" meta:base-class-count="7" xsl:is-literal="1">HTTP</xsl:template><xsl:template match="object:Error" mode="gs_classes_string" meta:base-class-count="7" xsl:is-literal="1">Error</xsl:template><xsl:template match="object:Manager" mode="gs_classes_string" meta:base-class-count="8" xsl:is-literal="1">Manager</xsl:template><xsl:template match="interface:ContextMenu" mode="gs_classes_string" meta:base-class-count="9" xsl:is-literal="1">ContextMenu</xsl:template><xsl:template match="interface:SubMenu" mode="gs_classes_string" meta:base-class-count="9" xsl:is-literal="1">SubMenu</xsl:template><!--base classes--><xsl:template match="*" mode="gs_base_classes_string" meta:base-class-count="2" xsl:is-literal="1">BaseObject,HTMLObject</xsl:template><xsl:template match="repository:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="repository:*" mode="gs_html_container" xsl:is-literal="1">ul</xsl:template><xsl:template match="class:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="xmltransaction:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="html:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="gs:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="css:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="response:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="object:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="xsd:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="interface:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="xml:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="database:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="xmltransaction:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="xsl:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="meta:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="rx:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="javascript:*" mode="gs_base_classes_string" meta:base-class-count="5" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="interface:Forum" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:ForumPost" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="xsl:include" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,XSL</xsl:template><xsl:template match="interface:HTMLWebpage" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="interface:HTMLWebpage" mode="gs_html_container" xsl:is-literal="1">html</xsl:template><xsl:template match="javascript:dependency" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,JS</xsl:template><xsl:template match="css:stylesheet" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,CSS</xsl:template><xsl:template match="interface:Debugger" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:MultiDocument" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:Explorer" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:IDE" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:Frame" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:MultiView" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:VerticalFrameset|interface:HorizontalFrameset" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:SharedInterfaces" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:AJAXHTMLLoader" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:Collection" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:Collection" mode="gs_html_container" xsl:is-literal="1">ul</xsl:template><xsl:template match="interface:HTMLContainer" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,HTML</xsl:template><xsl:template match="xsd:schema" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,XSD</xsl:template><xsl:template match="xsd:element|xsd:attribute|xsd:any" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,XSD</xsl:template><xsl:template match="xsl:template" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,XSL</xsl:template><xsl:template match="javascript:code" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,JS</xsl:template><xsl:template match="interface:QualifiedName" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="html:img" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,HTML</xsl:template><xsl:template match="interface:Menu" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:Menu" mode="gs_html_container" xsl:is-literal="1">ul</xsl:template><xsl:template match="xsl:stylesheet" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,XSL</xsl:template><xsl:template match="css:dependency" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,CSS</xsl:template><xsl:template match="xsl:variable|xsl:param" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,XSL</xsl:template><xsl:template match="object:Message" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:Response" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:LinkedServer" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:Request" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="repository:resources" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,Repository,DatabaseObject,DatabaseElement,HTMLObject</xsl:template><xsl:template match="repository:resources" mode="gs_html_container" xsl:is-literal="1">ul</xsl:template><xsl:template match="object:Website" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:User" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:Database" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:Session" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:Service" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:Group" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:Server" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:MessageInterpretation" mode="gs_base_classes_string" meta:base-class-count="6" xsl:is-literal="1">VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:Person" mode="gs_base_classes_string" meta:base-class-count="7" xsl:is-literal="1">VariableType,BaseObject,User,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="interface:AdvancedForum" mode="gs_base_classes_string" meta:base-class-count="7" xsl:is-literal="1">Forum,VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="xsd:attribute[@meta:editor-class = 'class:CodeMirrorEditor']" mode="gs_base_classes_string" meta:base-class-count="7" xsl:is-literal="1">XSDField,VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,XSD</xsl:template><xsl:template match="xsl:attribute[@meta:editor-class = 'class:Selector']" mode="gs_base_classes_string" meta:base-class-count="7" xsl:is-literal="1">XSDField,VariableType,BaseObject,DatabaseObject,DatabaseElement,HTMLObject,XSD</xsl:template><xsl:template match="interface:VerticalMenu" mode="gs_base_classes_string" meta:base-class-count="7" xsl:is-literal="1">VariableType,BaseObject,Menu,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:VerticalMenu" mode="gs_html_container" xsl:is-literal="1">ul</xsl:template><xsl:template match="interface:HorizontalMenu" mode="gs_base_classes_string" meta:base-class-count="7" xsl:is-literal="1">VariableType,BaseObject,Menu,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:HorizontalMenu" mode="gs_html_container" xsl:is-literal="1">ul</xsl:template><xsl:template match="object:HTTP" mode="gs_base_classes_string" meta:base-class-count="7" xsl:is-literal="1">VariableType,BaseObject,Service,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:Error" mode="gs_base_classes_string" meta:base-class-count="7" xsl:is-literal="1">VariableType,BaseObject,Message,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="object:Manager" mode="gs_base_classes_string" meta:base-class-count="8" xsl:is-literal="1">Person,VariableType,BaseObject,User,DatabaseObject,DatabaseElement,HTMLObject,ObjectClass</xsl:template><xsl:template match="interface:ContextMenu" mode="gs_base_classes_string" meta:base-class-count="9" xsl:is-literal="1">VariableType,BaseObject,VerticalMenu,Overlay,Menu,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:ContextMenu" mode="gs_html_container" xsl:is-literal="1">ul</xsl:template><xsl:template match="interface:SubMenu" mode="gs_base_classes_string" meta:base-class-count="9" xsl:is-literal="1">VariableType,BaseObject,VerticalMenu,Overlay,Menu,DatabaseObject,DatabaseElement,HTMLObject,Interface</xsl:template><xsl:template match="interface:SubMenu" mode="gs_html_container" xsl:is-literal="1">ul</xsl:template><!--/[/~Class/class_introspection.dxsl]--><!--[/~Class/website_classes_html_view_templates.dxsl] DXSL--><!--
      ######## gs_complementary_templates #########
      $gs_website_classes               [99]
      $gs_client_side_class_stylesheets [66]
      xsl:template/@match attributes have been morphed to include all derived class:*/@elements
      type:             [complement]
    --><xsl:param name="gs_response" select="object:Response"/><xsl:param name="gs_environment" select="$gs_response/meta:environment"/><xsl:param name="gs_user" select="$gs_environment/object:User"/><xsl:param name="gs_request" select="$gs_environment/object:Request"/><xsl:param name="gs_session" select="$gs_environment/object:Session"/><xsl:param name="gs_website_root" select="$gs_environment/object:Website"/><xsl:param name="gs_context_database" select="$gs_environment/object:Database"/><xsl:param name="gs_resource_server_object" select="$gs_environment/object:LinkedServer"/><xsl:param name="db" select="$gs_context_database"/><xsl:param name="website" select="$gs_website_root"/><xsl:param name="gs_newline" select="'&#10;'"/><xsl:param name="gs_lowercase" select="'abcdefghijklmnopqrstuvwxyz'"/><xsl:param name="gs_uppercase" select="'ABCDEFGHIJKLMNOPQRSTUVWXYZ'"/><xsl:param name="gs_request_id" select="string($gs_request/@id)"/><xsl:param name="gs_query_string" select="$gs_request/gs:query-string"/><xsl:param name="gs_form" select="$gs_request/gs:form"/><xsl:param name="gs_configuration_flags" select="string($gs_query_string/@configuration-flags)"/><xsl:param name="gs_is_logged_in" select="boolean($gs_user)"/><xsl:param name="gs_isadministrator" select="boolean($gs_user/gs:groups/object:Group[xml:id='grp_1'])"/><xsl:param name="gs_resource_server" select="$gs_resource_server_object/@uri"/><xsl:param name="gs_request_url" select="$gs_request/gs:url"/><xsl:param name="gs_request_target" select="$gs_response/gs:data/*"/><xsl:variable name="NAMESPACE_XXX" select="'http://general_server.org/xmlnamespaces/dummyxsl/2006'"/><xsl:variable name="NAMESPACE_GS" select="'http://general_server.org/xmlnamespaces/general_server/2006'"/><xsl:variable name="NAMESPACE_EXSL" select="'http://exslt.org/common'"/><xsl:variable name="NAMESPACE_CONVERSATION" select="'http://general_server.org/xmlnamespaces/conversation/2006'"/><xsl:variable name="NAMESPACE_XSD" select="'http://www.w3.org/2001/XMLSchema'"/><xsl:variable name="NAMESPACE_HTML" select="'http://www.w3.org/1999/xhtml'"/><xsl:variable name="NAMESPACE_XSL" select="'http://www.w3.org/1999/XSL/Transform'"/><xsl:variable name="NAMESPACE_DYN" select="'http://exslt.org/dynamic'"/><xsl:variable name="NAMESPACE_DATABASE" select="'http://general_server.org/xmlnamespaces/database/2006'"/><xsl:variable name="NAMESPACE_SERVER" select="'http://general_server.org/xmlnamespaces/server/2006'"/><xsl:variable name="NAMESPACE_DEBUG" select="'http://general_server.org/xmlnamespaces/debug/2006'"/><xsl:variable name="NAMESPACE_SERVICE" select="'http://general_server.org/xmlnamespaces/service/2006'"/><xsl:variable name="NAMESPACE_REQUEST" select="'http://general_server.org/xmlnamespaces/request/2006'"/><xsl:variable name="NAMESPACE_RESPONSE" select="'http://general_server.org/xmlnamespaces/response/2006'"/><xsl:variable name="NAMESPACE_RX" select="'http://general_server.org/xmlnamespaces/rx/2006'"/><xsl:variable name="NAMESPACE_REPOSITORY" select="'http://general_server.org/xmlnamespaces/repository/2006'"/><xsl:variable name="NAMESPACE_OBJECT" select="'http://general_server.org/xmlnamespaces/object/2006'"/><xsl:variable name="NAMESPACE_INTERFACE" select="'http://general_server.org/xmlnamespaces/interface/2006'"/><xsl:variable name="NAMESPACE_JAVASCRIPT" select="'http://general_server.org/xmlnamespaces/javascript/2006'"/><xsl:variable name="NAMESPACE_CLASS" select="'http://general_server.org/xmlnamespaces/class/2006'"/><xsl:variable name="NAMESPACE_CSS" select="'http://general_server.org/xmlnamespaces/css/2006'"/><xsl:variable name="NAMESPACE_XMLSECURITY" select="'http://general_server.org/xmlnamespaces/xmlsecurity/2006'"/><xsl:variable name="NAMESPACE_XMLTRANSACTION" select="'http://general_server.org/xmlnamespaces/xmltransaction/2006'"/><xsl:variable name="NAMESPACE_REGEXP" select="'http://exslt.org/regular-expressions'"/><xsl:variable name="NAMESPACE_META" select="'http://general_server.org/xmlnamespaces/meta/2006'"/><xsl:variable name="NAMESPACE_SESSION" select="'http://general_server.org/xmlnamespaces/session/2006'"/><xsl:variable name="NAMESPACE_FLOW" select="'http://exslt.org/flow'"/><xsl:variable name="NAMESPACE_STR" select="'http://exslt.org/strings'"/><xsl:template match="object:Manager" mode="full_title">
    <xsl:text>Dickhead.</xsl:text>
    (<xsl:value-of select="@test"/>)
  </xsl:template><xsl:template match="object:Test"/><xsl:template match="object:Person|object:Manager" mode="full_title">
    <xsl:text>Ms.</xsl:text>
    <xsl:value-of select="@test"/>
    <xsl:if xmlns="http://general_server.org/xmlnamespaces/general_server/2006" test="@test = 'wibble'" xsl:is-literal="1"><div xmlns="http://www.w3.org/1999/xhtml">Wibble mode!</div></xsl:if>
  </xsl:template><xsl:template match="interface:Forum|interface:AdvancedForum" mode="default_content">
  ...
  </xsl:template><xsl:template match="interface:Forum/*|interface:AdvancedForum/*" mode="summary"/><xsl:template match="interface:Forum/gs:title|interface:AdvancedForum/gs:title">
    <h1 class="{local-name()}"><xsl:value-of select="."/></h1>
  </xsl:template><xsl:template match="interface:Forum/gs:description|interface:AdvancedForum/gs:description">
    <div class="{local-name()}"><xsl:value-of select="."/></div>
  </xsl:template><xsl:template match="interface:ForumPost" mode="summary"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="interface:HTMLWebpage"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="interface:HTMLWebpage/html:head"/><xsl:template match="interface:HTMLWebpage/html:head/html:meta[@name='Copyright']">
    <xsl:comment>html:meta tag [<xsl:value-of select="@name"/>] not allowed</xsl:comment>
  </xsl:template><xsl:template match="interface:HTMLWebpage/html:head/html:meta[@charset]">
    <xsl:comment>html:meta tag [@charset] not allowed</xsl:comment>
  </xsl:template><xsl:template match="interface:HTMLWebpage/@*" mode="gs_view_render_head"/><xsl:template match="interface:HTMLWebpage/@response:classes" mode="gs_view_render_head">
    <xsl:comment><xsl:value-of select="."/></xsl:comment>
  </xsl:template><xsl:template match="interface:HTMLWebpage/@title" mode="gs_view_render_head">
    <title><xsl:value-of select="."/></title>
  </xsl:template><xsl:template match="interface:HTMLWebpage/@favicon" mode="gs_view_render_head">
    <link rel="shortcut icon" href="{.}"/>
    <link rel="icon" href="{.}" type="image/x-icon"/>
  </xsl:template><xsl:template match="interface:HTMLWebpage/@jQuery" mode="gs_view_render_head">
  ...
  </xsl:template><xsl:template match="interface:HTMLWebpage/@jQueryUI" mode="gs_view_render_head">
    <xsl:apply-templates select="." mode="gs_view_render_libraries">
      <xsl:with-param name="gs_standard_libraries" select="'jquery-ui'"/>
      <xsl:with-param name="gs_min" select="../@jQuery-delivery"/>
      <xsl:with-param name="gs_version" select="."/>
    </xsl:apply-templates>
  </xsl:template><xsl:template match="interface:HTMLWebpage/@standard-libraries" mode="gs_view_render_head">
    <xsl:apply-templates select="." mode="gs_view_render_libraries"/>
  </xsl:template><xsl:template match="interface:HTMLWebpage/@general-server-framework" mode="gs_view_render_head">
    <script type="text/javascript" src="/~JavaScript/repository:framework/javascript:code.js"/>
    
  </xsl:template><xsl:template match="interface:HTMLWebpage/@class-styles" mode="gs_view_render_head">
  ...
  </xsl:template><xsl:template match="interface:HTMLWebpage/@code-class" mode="gs_view_render_head">
  ...
  </xsl:template><xsl:template match="interface:HTMLWebpage/@code-class-dependencies" mode="gs_view_render_head">
    <xsl:apply-templates select="." mode="gs_external_class_javascript_dependencies"/>
  </xsl:template><xsl:template match="interface:HTMLWebpage/@class-style-dependencies" mode="gs_view_render_head">
    <xsl:apply-templates select="." mode="gs_external_class_css_dependencies"/>
  </xsl:template><xsl:template match="*|node()|@*|text()" mode="gs_view_render_libraries"><xsl:param name="gs_standard_libraries" select="string(.)"/><xsl:param name="gs_version"/><xsl:param name="gs_minified"/>
    ...
    <xsl:if test="not($gs_resource_server)"><xsl:comment>including [<xsl:value-of select="$gs_standard_library"/>] from same server because $gs_resource_server not present</xsl:comment></xsl:if>
  ...
  </xsl:template><xsl:template match="html:html" mode="editor">
    <xsl:apply-templates select="."/>
  </xsl:template><xsl:template match="html:html" mode="default_content">
    
    <xsl:apply-templates select="*" mode="gs_view_render"/>
  </xsl:template><xsl:template match="javascript:dependency" mode="html"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="css:stylesheet" mode="standalone_contents">
    
    <xsl:apply-templates select="." mode="html_details"/>
  </xsl:template><xsl:template match="css:stylesheet" mode="editor"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="css:stylesheet" mode="html"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="css:stylesheet" mode="html_details">
  ...
  </xsl:template><xsl:template match="*" mode="gs_css_stylesheet_clauses">
    <xsl:apply-templates select="*" mode="gs_css_stylesheet_clauses"/>
  </xsl:template><xsl:template match="css:stylesheet" mode="gs_listname">
    <xsl:text>view</xsl:text>
  </xsl:template><xsl:template match="css:dependency">
  ...
  </xsl:template><xsl:template match="css:*/text()">
    
    <xsl:value-of select="normalize-space(.)" disable-output-escaping="yes"/>
  </xsl:template><xsl:template match="css:raw">
    <xsl:apply-templates/>
  </xsl:template><xsl:template match="css:section"><xsl:param name="gs_object_name"/>
  ...
  </xsl:template><xsl:template match="css:clause/css:path|css:path">
    
  </xsl:template><xsl:template match="css:path" mode="gs_css_path_output">
    
    <xsl:apply-templates/>
  </xsl:template><xsl:template match="css:clause/css:path" mode="gs_css_path_output"><xsl:param name="gs_object_name"/>
  ...
  </xsl:template><xsl:template match="css:path/css:*" mode="gs_css_relation"><xsl:param name="gs_default"/>
  ...
  </xsl:template><xsl:template match="css:path/css:class">
    <xsl:apply-templates select="." mode="gs_css_relation"/>
    <xsl:text>.</xsl:text><xsl:apply-templates/>
    <xsl:apply-templates select="@*|../@*"/>
  </xsl:template><xsl:template match="css:path/css:interface">
    <xsl:apply-templates select="." mode="gs_css_relation">
      <xsl:with-param name="gs_default" select="'self'"/>
    </xsl:apply-templates>
    <xsl:text>.gs-interface-mode-</xsl:text><xsl:apply-templates/>
    <xsl:apply-templates select="@*|../@*"/>
  </xsl:template><xsl:template match="css:path/css:local-name">
    <xsl:apply-templates select="." mode="gs_css_relation">
      <xsl:with-param name="gs_default" select="'self'"/>
    </xsl:apply-templates>
    <xsl:text>.gs-local-name-</xsl:text><xsl:apply-templates/>
    <xsl:apply-templates select="@*|../@*"/>
  </xsl:template><xsl:template match="css:path/css:object">
    <xsl:apply-templates select="." mode="gs_css_relation"/>
    <xsl:text>.Class__</xsl:text><xsl:apply-templates/>
    <xsl:apply-templates select="@*|../@*"/>
  </xsl:template><xsl:template match="css:path/css:id">
    <xsl:apply-templates select="." mode="gs_css_relation"/>
    <xsl:text>#</xsl:text><xsl:apply-templates/>
    <xsl:apply-templates select="@*|../@*"/>
  </xsl:template><xsl:template match="css:path/css:element">
    <xsl:apply-templates select="." mode="gs_css_relation"/>
    <xsl:apply-templates/>
    <xsl:apply-templates select="@*|../@*"/>
  </xsl:template><xsl:template match="css:*/@*"/><xsl:template match="css:*/@with-class">
    <xsl:text>.</xsl:text><xsl:value-of select="."/>
  </xsl:template><xsl:template match="css:*/@with-pseudo">
    <xsl:text>:</xsl:text><xsl:value-of select="."/>
  </xsl:template><xsl:template match="css:*/@with-name">
  ...
  </xsl:template><xsl:template match="css:clause"><xsl:param name="gs_object_name"/>
    ...
    <xsl:text>}</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="css:clause/css:*">
  ...
  </xsl:template><xsl:template match="css:clause" mode="gs_css_item_collection"/><xsl:template match="css:*" mode="gs_css_item_collection">
    <xsl:value-of select="local-name()"/>
    <xsl:text>-</xsl:text>
  </xsl:template><xsl:template match="css:*" mode="gs_css_item">
    ...
    <xsl:text>;</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="css:font-family" mode="gs_css_stylesheet_clauses">
    
    <xsl:apply-templates select="str:split(., ',')" mode="gs_css_font_faces">
      <xsl:with-param name="gs_font_type" select="@type"/>
    </xsl:apply-templates>
  </xsl:template><xsl:template match="token[normalize-space(.)='Verdana']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Arial']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Helvetica']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Times New Roman']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Times']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Courier New']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Courier']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Georgia']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Palatino']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Garamond']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Bookman']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Comic Sans MS']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Trebuchet MS']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Arial Black']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='Impact']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='serif']" mode="gs_css_font_faces"/><xsl:template match="token[normalize-space(.)='sans-serif']" mode="gs_css_font_faces"/><xsl:template match="token" mode="gs_css_font_faces"><xsl:param name="gs_font_type"/>
    ...
    <xsl:text>}</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="css:icon" mode="gs_css_item">
    ...
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="css:section" mode="editor"><xsl:param name="gs_object_name"/>
  ...
  </xsl:template><xsl:template match="css:section/css:path" mode="editor"/><xsl:template match="css:clause" mode="editor"><xsl:param name="gs_object_name"/>
  ...
  </xsl:template><xsl:template match="css:clause/css:path" mode="editor"/><xsl:template match="css:clause/*" mode="editor">
  ...
  </xsl:template><xsl:template match="interface:Debugger"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="*" mode="gs_javascript_before_method"><xsl:param name="gs_object_name" select="'BaseObject'"/>
  ...
  </xsl:template><xsl:template match="javascript:object" mode="gs_javascript_before_method"><xsl:param name="gs_object_name" select="'BaseObject'"/>
  ...
  </xsl:template><xsl:template match="interface:MultiDocument" mode="default_content">
  ...
  </xsl:template><xsl:template match="gs:tab-template" mode="gs_full_tab">
  </xsl:template><xsl:template match="gs:tab" mode="gs_full_tab">
  ...
  </xsl:template><xsl:template match="gs:tab" mode="gs_full_tab_container">
    <xsl:variable name="gs_tab_id"><xsl:if test="@id"><xsl:value-of select="@id"/></xsl:if><xsl:if test="not(@id)"><xsl:value-of select="translate(@title, ' ', '-')"/></xsl:if></xsl:variable>

    <div id="tab-{$gs_tab_id}" class="gs-tab-container">
      <xsl:apply-templates select="." mode="gs_full_tab_content"/>
    </div>
  </xsl:template><xsl:template match="gs:tab" mode="gs_full_tab_content">
    
    <xsl:apply-templates mode="gs_view_render"/>
  </xsl:template><xsl:template match="interface:Explorer" mode="gs_event_functions">
    <xsl:text>f_ready_setFrameHeights f_resize_setFrameHeights</xsl:text>
  </xsl:template><xsl:template match="interface:IDE/@title" mode="full_title"/><xsl:template match="interface:IDE" mode="gs_doxygen_support">
  ...
  </xsl:template><xsl:template match="interface:IDE//xsd:schema[@name='search']" mode="gs_form_render_submit">
  ...
  </xsl:template><xsl:template match="interface:MultiView" mode="default_content">
  ...
  </xsl:template><xsl:template match="interface:MultiView/interface:SubMenu" mode="default_content">
    <xsl:apply-templates select="../gs:view" mode="gs_full_view"/>
    <xsl:apply-templates mode="gs_view_render"/>
  </xsl:template><xsl:template match="interface:MultiView" mode="editor"><xsl:param name="gs_html_identifier_class"/>
    
    <xsl:apply-templates select=".">
      <xsl:with-param name="gs_html_identifier_class" select="$gs_html_identifier_class"/>
    </xsl:apply-templates>
  </xsl:template><xsl:template match="gs:view" mode="gs_full_view">
  ...
  </xsl:template><xsl:template match="gs:sub-control" mode="gs_full_view_sub_control">
  ...
  </xsl:template><xsl:template match="gs:view" mode="gs_full_view_container">
  ...
  </xsl:template><xsl:template match="gs:view/gs:sub-control" mode="gs_full_view_content">
    
  </xsl:template><xsl:template match="*" mode="gs_full_view_content">
    
    <xsl:apply-templates select="." mode="gs_view_render"/>
  </xsl:template><xsl:template match="interface:AJAXHTMLLoader|interface:dynamic|database:query|database:wait-for-single-write-event" mode="gs_HTTP_render">
    ...
    <xsl:apply-templates select="^Class__AJAXHTMLLoader/envelope_loader" mode="gs_HTTP_render"/>
  </xsl:template><xsl:template match="interface:AJAXHTMLLoader" mode="editor"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_interface_mode"/>
  ...
  </xsl:template><xsl:template match="xsd:attribute[@meta:editor-class = 'class:CodeMirrorEditor']" mode="xpathajax"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_current_external_value_node" select="/.."/>
    
    
     

    <xsl:variable name="gs_xsd_schema" select="ancestor::xsd:schema[1]"/>
    <xsl:variable name="gs_destination_xpath" select="$gs_xsd_schema/xsd:annotation/xsd:documentation[@meta:type='destination']"/>
    ...
    <div class="{$gs_html_identifier_class} f_presubmit_updateFormElement f_appear_refresh f_resize_refresh">
      ...
      <xsl:if test="not($gs_destination_xpath)"><div class="gs_warning">cannot find xsd:documentation[@meta:type='destination'] in xsd:schema</div></xsl:if>
  ...
  </xsl:template><xsl:template match="xsd:schema"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_title" select="xsd:annotation/xsd:*[@meta:type='title']"/><xsl:param name="gs_submit" select="xsd:annotation/xsd:*[@meta:type='submit-caption']"/><xsl:param name="gs_description" select="xsd:annotation/xsd:*[@meta:type='description']"/><xsl:param name="gs_event_functions"/><xsl:param name="gs_current_value_node" select="xsd:annotation/xsd:*[@meta:type='edit-data']/*"/>
  ...
  </xsl:template><xsl:template match="xsd:schema//xsd:sequence/xsd:*" mode="gs_form_render_check_required_documentation">
    
  </xsl:template><xsl:template match="xsd:schema/xsd:annotation/xsd:documentation" mode="gs_form_render_documentation">
  ...
  </xsl:template><xsl:template match="xsd:schema" mode="gs_context_menu_custom">
    <li class="f_submit_ajax">submit form</li>
  </xsl:template><xsl:template match="xsd:schema" mode="gs_form_render_submit"><xsl:param name="gs_submit_defaulted"/>
    

    <input class="gs-form-submit" type="submit" name="gs--submit" value="{$gs_submit_defaulted}">
      
    </input>
  </xsl:template><xsl:template match="xsd:schema" mode="editor"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="xsd:annotation|xsd:app-info|xsd:documentation" mode="editor"/><xsl:template match="xsd:annotation[@meta:type = 'form-display']" mode="editor">
    <xsl:apply-templates select="*" mode="editor"/>
  </xsl:template><xsl:template match="xsd:documentation[@meta:type = 'order']" mode="editor"/><xsl:template match="xsd:annotation[@meta:type = 'data-processing']" mode="editor">
    <xsl:apply-templates select="*" mode="editor"/>
  </xsl:template><xsl:template match="xsd:app-info[@meta:type = 'processing']" mode="editor">
  ...
  </xsl:template><xsl:template match="xsd:app-info[@meta:type = 'context']" mode="editor">
    <xsl:apply-templates select="xsd:sequence" mode="editor"/>
  </xsl:template><xsl:template match="xsd:schema" mode="new"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="xsd:schema" mode="set"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="*" mode="selectoroption"><xsl:param name="gs_html_identifier_class"/>
    

    <li class="{$gs_html_identifier_class}">
      <xsl:value-of select="local-name()"/>
    </li>
  </xsl:template><xsl:template match="xsd:element|xsd:attribute|xsd:any|xsl:attribute[@meta:editor-class = 'class:Selector']|xsd:attribute[@meta:editor-class = 'class:CodeMirrorEditor']"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_interface_mode"/><xsl:param name="gs_current_external_value_node" select="/.."/>
  ...
  </xsl:template><xsl:template match="xsd:element|xsd:attribute|xsd:any|xsl:attribute[@meta:editor-class = 'class:Selector']|xsd:attribute[@meta:editor-class = 'class:CodeMirrorEditor']" mode="gs_form_render_item_input"><xsl:param name="gs_HTML_id"/><xsl:param name="gs_raw_name"/><xsl:param name="gs_value"/>
  ...
  </xsl:template><xsl:template match="xsd:restriction/xsd:pattern" mode="gs_form_render_item_input_validation">
    <span class="gs-xtransport gs-required"><xsl:value-of select="@value"/></span>
  </xsl:template><xsl:template match="xsd:annotation" mode="gs_form_render_item_input_field_message">
  ...
  </xsl:template><xsl:template match="xsd:annotation" mode="gs_form_render_item_input_help">
    <div class="gs-xsd-help"><xsl:value-of select="xsd:documentation"/></div>
  </xsl:template><xsl:template match="xsd:element|xsd:attribute|xsd:any|xsl:attribute[@meta:editor-class = 'class:Selector']|xsd:attribute[@meta:editor-class = 'class:CodeMirrorEditor']" mode="editor"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_field_model" select="ancestor::xsd:schema[1]/xsd:annotation[@meta:type='data-queries']/xsd:app-info[@meta:type='field-model']/xsd:schema"/><xsl:param name="gs_field_types" select="ancestor::xsd:schema[1]/xsd:annotation[@meta:type='data-queries']/xsd:app-info[@meta:type='field-types']/xsd:schema"/>
  ...
  </xsl:template><xsl:template match="xsd:element|xsd:attribute|xsd:any|xsl:attribute[@meta:editor-class = 'class:Selector']|xsd:attribute[@meta:editor-class = 'class:CodeMirrorEditor']" mode="gs_xsd_occurs"><xsl:param name="gs_setting"/><xsl:param name="gs_int" select="0"/>
  ...
  </xsl:template><xsl:template match="xsd:element|xsd:attribute|xsd:any|xsl:attribute[@meta:editor-class = 'class:Selector']|xsd:attribute[@meta:editor-class = 'class:CodeMirrorEditor']" mode="gs_xsd_occurs_output"><xsl:param name="gs_setting"/><xsl:param name="gs_int"/><xsl:param name="gs_caption"/>
  ...
  </xsl:template><xsl:template match="xsd:element|xsd:attribute|xsd:any|xsd:sequence|xsl:attribute[@meta:editor-class = 'class:Selector']|xsd:sequence|xsd:attribute[@meta:editor-class = 'class:CodeMirrorEditor']|xsd:sequence" mode="gs_xsd_type_options">
  ...
  </xsl:template><xsl:template match="*" mode="gs_xsd_type_options_output"><xsl:param name="gs_element"/>
  ...
  </xsl:template><xsl:template match="xsd:element|xsd:attribute|xsd:any|xsl:attribute[@meta:editor-class = 'class:Selector']|xsd:attribute[@meta:editor-class = 'class:CodeMirrorEditor']" mode="new"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_interface_mode"/>
  ...
  </xsl:template><xsl:template match="xsd:element|xsd:attribute|xsd:any|xsl:attribute[@meta:editor-class = 'class:Selector']|xsd:attribute[@meta:editor-class = 'class:CodeMirrorEditor']" mode="set"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_interface_mode"/>
  ...
  </xsl:template><xsl:template match="xsl:template"><xsl:param name="gs_html_identifier_class"/>
    

    <div class="{$gs_html_identifier_class}">
      Templatey
    </div>
  </xsl:template><xsl:template match="xsl:template" mode="gs_listname">
    <xsl:if test="@name">{<xsl:value-of select="@name"/>}</xsl:if>
    <xsl:if test="@match">[<xsl:value-of select="@match"/>]</xsl:if>
    <xsl:if test="@mode"> (<xsl:value-of select="@mode"/>)</xsl:if>
  </xsl:template><xsl:template match="xsl:template" mode="view"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_interface_mode"/>
  ...
  </xsl:template><xsl:template match="xsl:template" mode="gs_javascript_xsl_templates"><xsl:param name="gs_object_name"/>
  ...
  </xsl:template><xsl:template match="xsl:param" mode="gs_javascript_xsl_templates_names">
    <xsl:text>"</xsl:text>
    <xsl:value-of select="@name"/>
    <xsl:text>"</xsl:text>
    <xsl:if test="not(position() = last())">,</xsl:if>
  </xsl:template><xsl:template match="xsl:param" mode="gs_javascript_xsl_templates">
    <xsl:text>, </xsl:text>
    <xsl:value-of select="@name"/>
  </xsl:template><xsl:template match="xsl:template" mode="controller"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_interface_mode"/>
  ...
  </xsl:template><xsl:template match="javascript:ifdef"><xsl:param name="gs_object_name"/>
  ...
  </xsl:template><xsl:template match="javascript:stage-dev"><xsl:param name="gs_object_name"/>
  ...
  </xsl:template><xsl:template match="javascript:code" mode="standalone_contents"><xsl:param name="gs_class" select="parent::class:*"/>
    
    
    <xsl:apply-templates select="." mode="html_details">
      <xsl:with-param name="gs_class" select="$gs_class"/>
    </xsl:apply-templates>
  </xsl:template><xsl:template match="javascript:code" mode="editor"><xsl:param name="gs_html_identifier_class"/>
    
    

    <div class="{$gs_html_identifier_class} details" xml:add-xml-id="no">
      
      <ul><xsl:apply-templates select="javascript:dependency" mode="editor"/></ul>

      <xsl:apply-templates mode="editor"/>
    </div>
  </xsl:template><xsl:template match="javascript:code" mode="html"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="javascript:code" mode="html_details"><xsl:param name="gs_class" select="parent::class:*"/>
    
    
    <xsl:apply-templates select="javascript:*">
      <xsl:with-param name="gs_class" select="$gs_class"/>
    </xsl:apply-templates>
  </xsl:template><xsl:template match="javascript:code" mode="gs_listname">
    <xsl:text>controller</xsl:text>
  </xsl:template><xsl:template match="html:script" mode="gs_listname">
  ...
  </xsl:template><xsl:template match="javascript:*/text()">
    <xsl:value-of select="." disable-output-escaping="yes"/>
  </xsl:template><xsl:template match="javascript:raw">
    
    <xsl:apply-templates/>
  </xsl:template><xsl:template match="javascript:dependency">
    <xsl:text>//javascript:dependency on [</xsl:text>
    <xsl:value-of select="@uri"/>
    <xsl:text>] rendered outside this script</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:with-param">
    alert(document.XMLDocument);
    var <xsl:value-of select="@name"/> = "<xsl:value-of select="translate(@select, '&quot;', '_')"/>";
  </xsl:template><xsl:template match="javascript:assert">
    if (!<xsl:value-of select="@test"/>) alert("<xsl:value-of select="translate(@message, '&quot;', '_')"/>");
  </xsl:template><xsl:template match="javascript:define|javascript:global-variable">
    ...
    <xsl:text>;</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:override">
    ...
    <xsl:text>}</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:global-function">
    ...
    <xsl:text>}</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:global-init"><xsl:param name="gs_object_name" select="'Global'"/>
    ...
    <xsl:text>);</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:jquery-expression-extension">
    ...
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:jquery-extension">
    ...
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:jquery-static-extension">
    ...
    <xsl:value-of select="$gs_prototype_path"/><xsl:text>.extension = true;</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:jquery-event-extension">
    ...
    <xsl:text>}</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:javascript-static-extension-property">
    ...
    <xsl:text>;</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:javascript-extension|javascript:javascript-static-extension">
    ...
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:object|javascript:namespace"><xsl:param name="gs_class" select="parent::javascript:code/parent::class:*"/>
  ...
  </xsl:template><xsl:template match="javascript:object/javascript:object">
    <xsl:comment>sub-objects [<xsl:value-of select="../@xml:id"/>/<xsl:value-of select="@xml:id"/>] not supported yet</xsl:comment>
  </xsl:template><xsl:template match="*" mode="gs_context_menu_views"/><xsl:template match="*" mode="gs_context_menu_controllers"/><xsl:template match="@base-class-count|@name|@is-library-wrapper" mode="gs_javascript_class_attributes"/><xsl:template match="@*" mode="gs_javascript_class_attributes"><xsl:param name="gs_object_name"/>
    ...
    <xsl:text>);</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:object" mode="gs_inheritance_render_base_list">
    <xsl:value-of select="local-name(../parent::class:*)"/>
    <xsl:if test="not(position() = last())">,</xsl:if>
  </xsl:template><xsl:template match="javascript:object" mode="gs_inheritance_render_init_chain">
    <xsl:value-of select="local-name(../parent::class:*)"/>
    <xsl:text>.apply(this, arguments);</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="class:*" mode="gs_javascript_friends"><xsl:param name="gs_object_name"/>
  ...
  </xsl:template><xsl:template match="javascript:object" mode="gs_inheritance_render"><xsl:param name="gs_class"/><xsl:param name="gs_object_name"/>
    ...
    <xsl:text>);</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:object/javascript:init" mode="gs_in_object_init">
    
    <xsl:apply-templates/>
  </xsl:template><xsl:template match="javascript:object/javascript:init"/><xsl:template match="javascript:enum"><xsl:param name="gs_object_name"/>
    ...
    <xsl:apply-templates/>
    <xsl:text>};</xsl:text>
  </xsl:template><xsl:template match="javascript:conversion" mode="gs_function_name">
    <xsl:value-of select="concat('to', @to-type)"/>
  </xsl:template><xsl:template match="javascript:enum/javascript:value">
    <xsl:text>"</xsl:text><xsl:value-of select="@name"/><xsl:text>"</xsl:text>:<xsl:value-of select="."/><xsl:text>,</xsl:text>
  </xsl:template><xsl:template match="javascript:object/javascript:object-property"/><xsl:template match="javascript:object/javascript:object-property" mode="gs_in_object_init"><xsl:param name="gs_object_name"/>
    ...
    <xsl:text>;</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:object/javascript:fixed-prototype-property"><xsl:param name="gs_object_name"/>
    ...
    <xsl:text>;</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="*|@*|text()" mode="gs_check_javascript_reserved_words">
    
  </xsl:template><xsl:template match="*" mode="gs_javascript_function_init"/><xsl:template match="*" mode="gs_javascript_after_function"/><xsl:template match="@name|@parameters|@xml:id|@is-protected|@parameter-checks" mode="gs_function_attributes"/><xsl:template match="javascript:static-method/@*|javascript:conversion/@*" mode="gs_function_attributes"/><xsl:template match="@*" mode="gs_function_attributes"><xsl:param name="gs_object_name"/>
    ...
    <xsl:text>);</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:event-handler" mode="gs_javascript_function_init">
  ...
  </xsl:template><xsl:template match="javascript:static-event-handler" mode="gs_javascript_function_init">
    <xsl:variable name="gs_action" select="string(@action)"/>
    <xsl:variable name="gs_content" select="string(.)"/>
  ...
  </xsl:template><xsl:template match="javascript:*" mode="gs_function_name">
    <xsl:value-of select="@name"/>
  </xsl:template><xsl:template match="javascript:event-handler|javascript:static-event-handler" mode="gs_function_name">
    
    <xsl:text>f_</xsl:text>
    <xsl:value-of select="@event"/>
    <xsl:if test="string(@action)">_<xsl:value-of select="@action"/></xsl:if>
  </xsl:template><xsl:template match="javascript:method|javascript:conversion|javascript:event-handler|javascript:capability"><xsl:param name="gs_object_name"/>
    ...
    <xsl:apply-templates select="." mode="gs_javascript_after_function"/>
  </xsl:template><xsl:template match="javascript:*/@requires"><xsl:param name="gs_requires" select="string(.)"/>
  ...
  </xsl:template><xsl:template match="javascript:object/javascript:static-method|javascript:namespace/javascript:static-method|javascript:object/javascript:static-event-handler|javascript:object/javascript:static-capability"><xsl:param name="gs_object_name"/>
    ...
    <xsl:apply-templates select="." mode="gs_javascript_after_function"/>
  </xsl:template><xsl:template match="javascript:object/javascript:static-property|javascript:namespace/javascript:static-property"><xsl:param name="gs_object_name"/>
  ...
  </xsl:template><xsl:template match="xsd:schema" mode="gs_javascript_xsd_model"><xsl:param name="gs_object_name"/>
    ...
    <xsl:text>');</xsl:text>
    <xsl:value-of select="$gs_newline"/>
  </xsl:template><xsl:template match="javascript:object" mode="editor">
    <pre>
      <xsl:apply-templates select="."/>
    </pre>
  </xsl:template><xsl:template match="javascript:dependency" mode="editor">
    <li><xsl:value-of select="@uri"/></li>
  </xsl:template><xsl:template match="javascript:object" mode="eventhandler"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="javascript:event-handler" mode="eventhandler"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_interface_mode"/>
  ...
  </xsl:template><xsl:template match="interface:QualifiedName"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="*" mode="gs_delimit"><xsl:param name="gs_delimiter" select="', '"/>
  ...
  </xsl:template><xsl:template match="interface:Overlay|interface:SubMenu|interface:ContextMenu" mode="gs_extra_classes">
  ...
  </xsl:template><xsl:template match="*" mode="gs_extra_classes_overlay_transition"/><xsl:template match="*" mode="gs_extra_classes_overlay_exclusivity"/><xsl:template match="*" mode="gs_extra_classes_overlay_position"/><xsl:template match="interface:ContextMenu" mode="gs_extra_classes_overlay_transition">instant</xsl:template><xsl:template match="interface:ContextMenu" mode="gs_extra_classes_overlay_exclusivity">global</xsl:template><xsl:template match="interface:ContextMenu" mode="gs_extra_classes_overlay_position">mouse</xsl:template><xsl:template match="interface:Menu//gs:menu-section|interface:HorizontalMenu//gs:menu-section|interface:VerticalMenu//gs:menu-section|interface:SubMenu//gs:menu-section|interface:ContextMenu//gs:menu-section">
    <xsl:if test="*">
  ...
  </xsl:template><xsl:template match="interface:Menu//gs:menu-section|interface:HorizontalMenu//gs:menu-section|interface:VerticalMenu//gs:menu-section|interface:SubMenu//gs:menu-section|interface:ContextMenu//gs:menu-section">
    <xsl:if test="*">
      <xsl:if test="preceding-sibling::*">
        <li class="gs-menu-section"/>
      </xsl:if>
  ...
  </xsl:template><xsl:template match="interface:SubMenu" mode="gs_extra_classes_overlay_exclusivity">sibling</xsl:template><xsl:template match="xsl:stylesheet" mode="editor"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="database:query" mode="xsl_stylesheet_editor">
    <li>
      <xsl:attribute name="class">
  ...
  </xsl:template><xsl:template match="database:query" mode="gs_context_menu_custom">
    <li class="f_click_select_children">browse data</li>
  </xsl:template><xsl:template match="xsl:output/@*" mode="xsl_stylesheet_editor">
    <form><input id="gs_option_{name()}" name="{name()}" type="checkbox"/><label for="gs_option_{name()}"><xsl:value-of select="name()"/></label></form>
  </xsl:template><xsl:template match="xsl:include" mode="xsl_stylesheet_editor">
    <li>
      <xsl:attribute name="class">
  ...
  </xsl:template><xsl:template match="xsl:variable" mode="xsl_stylesheet_editor">
    <li>
      <xsl:attribute name="class">
  ...
  </xsl:template><xsl:template match="xsl:stylesheet/@*" mode="xsl_stylesheet_editor"/><xsl:template match="xsl:stylesheet/@meta:*" mode="xsl_stylesheet_editor">
    <form><input id="gs_option_{name()}" name="{name()}" type="checkbox"/><label for="gs_option_{name()}"><xsl:value-of select="name()"/></label></form>
  </xsl:template><xsl:template match="xsl:template" mode="xsl_stylesheet_editor"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="node()" mode="gs_formatted_output">
  ...
  </xsl:template><xsl:template match="node()" mode="gs_formatted_output_recursive"><xsl:param name="text"/>
  ...
  </xsl:template><xsl:template match="xsl:stylesheet" mode="gs_listname">
    <xsl:if test="@name"><xsl:value-of select="@name"/></xsl:if>
    <xsl:if test="not(@name)">stylesheet</xsl:if>
  </xsl:template><xsl:template match="xsl:stylesheet" mode="view"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="xsl:stylesheet" mode="controller"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="css:dependency" mode="html">
  ...
  </xsl:template><xsl:template match="xsl:variable|xsl:param" mode="controller"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="repository:*" mode="gs_HTTP_render">
  ...
  </xsl:template><xsl:template match="repository:*" mode="editor"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="object:Response">
    ...
    <xsl:apply-templates select="*" mode="gs_view_render"/>
  </xsl:template><xsl:template match="object:Response/gs:data">
    <xsl:apply-templates select="*" mode="gs_view_render">
      <xsl:with-param name="gs_interface_mode" select="parent::object:Response/@gs:force-data-interface"/>
    </xsl:apply-templates>
  </xsl:template><xsl:template match="object:Request" mode="default_content">
    
    <xsl:text>Styley</xsl:text>
  </xsl:template><xsl:template match="object:Request" mode="gs_listname">
    <xsl:if test="@name"><xsl:value-of select="@name"/></xsl:if>
    <xsl:if test="not(@name)">request</xsl:if>
  </xsl:template><xsl:template match="object:Request/@url" mode="gs_list_attributes">
    <li class="attribute_{local-name()}"><xsl:value-of select="name()"/> (<xsl:value-of select="."/>)</li>
  </xsl:template><xsl:template match="object:Request/@method[.='POST']" mode="gs_list_attributes">
    <li class="attribute_{local-name()} attribute_value_post"><xsl:value-of select="name()"/> (<xsl:value-of select="."/>)</li>
  </xsl:template><xsl:template match="xsl:template/@match|xsl:output/@method|gs:HTTP/@type|object:Session/@id">
    
    <li class="attribute_{local-name()}"><xsl:value-of select="name()"/> (<xsl:value-of select="."/>)</li>
  </xsl:template><xsl:template match="object:User|object:Person|object:Manager" mode="securityowner"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="object:User|object:Person|object:Manager" mode="default_content">
  ...
  </xsl:template><xsl:template match="object:User|object:Person|object:Manager" mode="full_title">
    <xsl:value-of select="@name"/>
  </xsl:template><xsl:template match="object:User|object:Person|object:Manager" mode="controls"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="object:User/repository:errors|object:Person/repository:errors|object:Manager/repository:errors" mode="controls">
  ...
  </xsl:template><xsl:template match="object:User/repository:errors/gs:error|object:Person/repository:errors/gs:error|object:Manager/repository:errors/gs:error" mode="controls">
    <li>error</li>
  </xsl:template><xsl:template match="gs:debug" mode="controls">
  ...
  </xsl:template><xsl:template match="gs:debug/gs:breakpoints" mode="controls">
    <ul id="gs_breakpoints">
      <xsl:apply-templates select="*" mode="controls"/>
    </ul>
  </xsl:template><xsl:template match="gs:breakpoints/*" mode="controls">
    <li><xsl:value-of select="local-name()"/> (<xsl:value-of select="@xml:id"/>)</li>
  </xsl:template><xsl:template match="gs:breakpoints/*/*"/><xsl:template match="gs:breakpoints/*/*"/><xsl:template match="gs:breakpoints/*/*" mode="list"><xsl:param name="gs_event_functions"/>
    
  </xsl:template><xsl:template match="object:Session" mode="controls"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="fake-template-source-warning">
  ...
  </xsl:template><xsl:template match="/"><xsl:param name="gs_interface_mode"/>
  ...
  </xsl:template><xsl:template match="object:Service|object:HTTP" mode="default_content">
    
    <xsl:text>Servicey</xsl:text>
  </xsl:template><xsl:template match="object:Service/@port|object:HTTP/@port" mode="gs_list_attributes">
    <li class="attribute_{local-name()}"><xsl:value-of select="name()"/> (<xsl:value-of select="."/>)</li>
  </xsl:template><xsl:template match="object:Service|object:HTTP" mode="gs_context_menu_custom">
    <li class="f_click_stop">stop</li>
  </xsl:template><xsl:template match="object:Group" mode="securityowner"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="xmltransaction:*" mode="gs_context_menu_custom">
    <li class="f_click_run">run</li>
  </xsl:template><xsl:template match="object:MessageInterpretation" mode="default_content">
    
    <xsl:text>MessageInterpretation</xsl:text>
  </xsl:template><xsl:template match="object:MessageInterpretation" mode="gs_listname">
    <xsl:value-of select="@name"/>
  </xsl:template><xsl:template match="*" mode="gs_inherited_css_classes"><xsl:param name="gs_class_definitions" select="."/>
  ...
  </xsl:template><xsl:template match="*" mode="gs_class_definitions"><xsl:param name="gs_class_definitions"/>
  ...
  </xsl:template><xsl:template match="*" mode="link"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_interface_mode"/>
  ...
  </xsl:template><xsl:template match="*" mode="gs_extra_classes"/><xsl:template match="*" mode="default_content"><xsl:param name="gs_interface_mode"/>
    
    

    <xsl:apply-templates select="@title|@title-1|@title-2|@title-3|@title-4|@title-5" mode="full_title"/>
    <xsl:apply-templates mode="gs_view_render"/>
  </xsl:template><xsl:template match="@title" mode="full_title">
    <div class="gs-title"><xsl:value-of select="."/></div>
  </xsl:template><xsl:template match="@title-1" mode="full_title">
    <h1><xsl:value-of select="."/></h1>
  </xsl:template><xsl:template match="@title-2" mode="full_title">
    <h2><xsl:value-of select="."/></h2>
  </xsl:template><xsl:template match="@title-3" mode="full_title">
    <h3><xsl:value-of select="."/></h3>
  </xsl:template><xsl:template match="@title-4" mode="full_title">
    <h4><xsl:value-of select="."/></h4>
  </xsl:template><xsl:template match="@title-5" mode="full_title">
    <h5><xsl:value-of select="."/></h5>
  </xsl:template><xsl:template match="*" mode="gs_html_identifier_class"><xsl:param name="gs_interface_mode" select="@gs:interface-mode"/><xsl:param name="gs_event_functions" select="@meta:event-functions"/><xsl:param name="gs_display_class" select="@gs:display-class"/><xsl:param name="gs_no_xml_id" select="false()"/>
  ...
  </xsl:template><xsl:template match="*" mode="gs_event_functions"/><xsl:template match="*" mode="gs_meta_data_standard_groups"><xsl:param name="gs_interface_mode" select="'default'"/>
  ...
  </xsl:template><xsl:template match="*" mode="gs_meta_data"><xsl:param name="gs_namespace_uri"/><xsl:param name="gs_meta_data" select="@*[namespace-uri() = $gs_namespace_uri]"/><xsl:param name="gs_group_name"/><xsl:param name="gs_js_load_as" select="'Options'"/><xsl:param name="gs_display_specific" select="false()"/><xsl:param name="gs_include_namespace" select="false()"/>
  ...
  </xsl:template><xsl:template match="*|@*" mode="gs_xtransport_values">
    <div class="{local-name()}"><xsl:value-of select="."/></div>
  </xsl:template><xsl:template match="text()" mode="gs_xtransport_values">
    <div class="gs-text"><xsl:value-of select="."/></div>
  </xsl:template><xsl:template match="*" mode="list"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_interface_mode"/><xsl:param name="gs_sub_interface"/><xsl:param name="gs_event_functions"/>
  ...
  </xsl:template><xsl:template match="*" mode="gs_list_childControl"><xsl:param name="gs_interface_mode"/><xsl:param name="gs_children_retrieved_class"/>
  ...
  </xsl:template><xsl:template match="*" mode="gs_list_details">
  ...
  </xsl:template><xsl:template match="*" mode="gs_list_pre_additions"/><xsl:template match="*" mode="gs_list_post_additions"/><xsl:template match="@*" mode="gs_list_style"/><xsl:template match="@tree-icon" mode="gs_list_style">
    <xsl:text>background-image:url(</xsl:text>
    <xsl:value-of select="$gs_resource_server"/>
    <xsl:text>/resources/shared/images/icons/</xsl:text>
    <xsl:value-of select="."/>
    <xsl:text>.png);</xsl:text>
  </xsl:template><xsl:template match="*" mode="listname"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_interface_mode"/>
  ...
  </xsl:template><xsl:template match="*" mode="gs_listname">
    <xsl:choose>
  ...
  </xsl:template><xsl:template match="@*" mode="gs_list_attributes"/><xsl:template match="*" mode="securitypermissions"><xsl:param name="gs_html_identifier_class"/>
  ...
  </xsl:template><xsl:template match="*" mode="gs_security_unix_permission"><xsl:param name="digit"/>
  ...
  </xsl:template><xsl:template match="*" mode="environment"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_interface_mode"/>
  ...
  </xsl:template><xsl:template match="@*" mode="gs_field_name_attribute">
    <span class="Field gs-field-name-attribute">
      <xsl:apply-templates select="."/>
    </span>
  </xsl:template><xsl:template match="*" mode="gs_field_localname">
    <span class="Field gs-field-localname">
      <xsl:value-of select="translate(local-name(), '_', ' ')"/>
    </span>
  </xsl:template><xsl:template match="@*" mode="gs_field_attribute">
    <span class="Field gs-field-attribute gs-name-{local-name()}">
      <xsl:apply-templates select="."/>
    </span>
  </xsl:template><xsl:template match="@*" mode="gs_field_element">
  ...
  </xsl:template><xsl:template match="*" mode="gs_client_side_xsl_warnings">
    <xsl:apply-templates select="*" mode="gs_client_side_xsl_warnings"/>
  </xsl:template><xsl:template match="html:*" mode="gs_client_side_xsl_warnings">
  ...
  </xsl:template><xsl:template match="xsl:value-of" mode="gs_client_side_xsl_warnings">
  ...
  </xsl:template><xsl:template match="meta:*">
    
  </xsl:template><xsl:template match="*"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_interface_mode"/>
  ...
  </xsl:template><xsl:template match="xsd:attribute[@meta:editor-class = 'class:Selector']"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_current_external_value_node" select="/.."/>
  ...
  </xsl:template><xsl:template match="xsd:attribute[@meta:editor-class = 'class:CodeMirrorEditor']"><xsl:param name="gs_html_identifier_class"/><xsl:param name="gs_current_external_value_node" select="/.."/>
    ...
    <div class="{$gs_html_identifier_class} f_presubmit_updateFormElement f_appear_refresh f_resize_refresh">
      ...
      $gs_website_classes               [99]
      type:             [complement]
    --><xsl:template match="@*|node()" mode="gs_external_class_javascript_dependencies" xsl:is-literal="1"><xsl:comment xsl:is-literal="1">gs_external_class_javascript_dependencies</xsl:comment><script type="text/javascript" class=" details" xml:add-xml-id="no" xsl:is-literal="1" src="http://general-resources-server.localhost/resources/shared/jquery/plugins/splitter/js/jquery.splitter-0.14.0.js" gs:object-name="Explorer"/><script type="text/javascript" class=" details" xml:add-xml-id="no" xsl:is-literal="1" src="http://general-resources-server.localhost/resources/shared/codemirror/codemirror-3.20/lib/codemirror.js" gs:object-name="CodeMirrorEditor"/><script type="text/javascript" class=" details" xml:add-xml-id="no" xsl:is-literal="1" src="http://general-resources-server.localhost/resources/shared/codemirror/codemirror-3.20/addon/fold/foldcode.js" gs:object-name="CodeMirrorEditor"/><script type="text/javascript" class=" details" xml:add-xml-id="no" xsl:is-literal="1" src="http://general-resources-server.localhost/resources/shared/codemirror/codemirror-3.20/mode/javascript/javascript.js" gs:object-name="CodeMirrorEditor"/><script type="text/javascript" class=" details" xml:add-xml-id="no" xsl:is-literal="1" src="http://general-resources-server.localhost/resources/shared/codemirror/codemirror-3.20/mode/xml/xml.js" gs:object-name="CodeMirrorEditor"/><script type="text/javascript" class=" details" xml:add-xml-id="no" xsl:is-literal="1" src="http://general-resources-server.localhost/resources/shared/codemirror/gs-xml.js" gs:object-name="CodeMirrorEditor"/><script type="text/javascript" class=" details" xml:add-xml-id="no" xsl:is-literal="1" src="http://general-resources-server.localhost/resources/shared/codemirror/codemirror-3.1/addon/format/formatting.js" gs:object-name="CodeMirrorEditor"/></xsl:template><xsl:template match="@*|node()" mode="gs_external_class_css_dependencies" xsl:is-literal="1"><xsl:comment xsl:is-literal="1">gs_external_class_css_dependencies</xsl:comment><link rel="stylesheet" xml:add-xml-id="no" xsl:is-literal="1" href="http://general-resources-server.localhost/resources/shared/jquery/plugins/splitter/css/jquery.splitter.css" gs:object-name=""/><link rel="stylesheet" xml:add-xml-id="no" xsl:is-literal="1" href="http://general-resources-server.localhost/resources/shared/codemirror/codemirror-3.20/lib/codemirror.css" gs:object-name=""/></xsl:template><!--/[/~Class/website_classes_html_dependencies.dxsl]--></xsl:stylesheet>
