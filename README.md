...
[![Security Scan](https://github.com/anewholm/general_resources_server/actions/workflows/semgrep.yml/badge.svg)](https://github.com/anewholm/general_resources_server/actions/workflows/semgrep.yml) \(_Semgrep scan development in progress_...\)
